...
const schema_data = {
    ...
    "linkDataArray": [
        ...
        {
            "from": "event_output_port_1",
            "to": "event_input_port_1"
        },
        {
            "from": "stream_port_10",
            "to": "stream_port_11"
        ...
        {
            "from": "modechange_output_port_1",
            "to": "modechange_input_port_1"
        }
    ],
    "nodeDataArray": [
        {
            "HEIGHT": 100,
            "WIDTH": 100,
            "buildUnit": "Build Unit 1",
            "category": "processingComponent",
            "group": "factory_1",
            "isGroup": true,
            "key": "processing_component_1",
            "loc": "280 -180",
            "mode": "Mode A"
        },
        {
                        ...
                        "events": [
                            {
                                "name": "event_1",
                                "next_mode": "Mode A",
                                "output_internal_data_items": true
                            },
                            {
                                "name": "event_2",
                                "next_mode": "Mode B",
        ...
        },
        {
            ...
            "loc": "162.5 -331.7917127899999",
            "mode": "Mode A"
        },
        {
            "HEIGHT": 100,
            "WIDTH": 100,
            "buildUnit": "Build Unit 2",
            "category": "processingComponent",
            "group": "factory_1",
            "isGroup": true,
            "key": "processing_component_3",
            "loc": "280 -180",
            "mode": "Mode B"
        },
        {
        ...
        },
        {
            ...
            "fusionRule": {
                ...
                "optional_ports_threshold": "0"
            },
            "haveOutputPort": true,
            "isGroup": true,
            "key": "fusion_operator_1",
            "loc": "760 -130.00000000000003"
        },
        {
            "Channel": "fusioned",
            "PORT_TYPE": "STREAM_OUTPUT_PORT",
        ...
        },
        {
            ...
            "group": "processing_component_4",
            "key": "modechange_output_port_1",
            "loc": "1020 -342.83166608810427"
        },
        {
            "Channel": "asd",
            "MessageType": "Float32",
